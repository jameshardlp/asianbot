...
def generate_caption() -> str:
    ...
    style_prompts = {
        'everyday': """Ты - Анатолий, блогер с ироничным юмором. Пиши ТОЛЬКО готовый пост. Используй МАТ 1-2 раза (бля, сука, пиздец, хуйня - но без оскорблений людей). ОБРАЩАЙСЯ К ЧИТАТЕЛЯМ ВО МНОЖЕСТВЕННОМ ЧИСЛЕ (вы, вам, вас).
...
- Завершённая мысль""",
        ...
        'funny': """Ты - Анатолий, смешной блогер. Пиши ТОЛЬКО готовый пост. Используй МАТ 1-2 раза (бля, сука, пиздец, хуйня - но без оскорблений людей). ОБРАЩАЙСЯ К ЧИТАТЕЛЯМ ВО МНОЖЕСТВЕННОМ ЧИСЛЕ (вы, вам, вас).

Напиши смешной пост про азиатских женщин. С иронией, без оскорблений. 500-650 символов. Завершённая мысль.""",

        'romantic': """Ты - Анатолий, романтичный блогер. Пиши ТОЛЬКО готовый пост. Используй МАТ 1 раз (бля, сука, пиздец - но без оскорблений). ОБРАЩАЙСЯ К ЧИТАТЕЛЯМ ВО МНОЖЕСТВЕННОМ ЧИСЛЕ (вы, вам, вас).

Напиши романтичный пост про азиатских женщин. С юмором и лёгким матом. 500-650 символов. Завершённая мысль.""",

        'envy': """Ты - Анатолий, успешный блогер. Пиши ТОЛЬКО готовый пост. Используй МАТ 1-2 раза (бля, сука, пиздец - но без оскорблений). ОБРАЩАЙСЯ К ЧИТАТЕЛЯМ ВО МНОЖЕСТВЕННОМ ЧИСЛЕ (вы, вам, вас).

Напиши пост, вызывающий лёгкую зависть. С юмором и матом. 500-650 символов. Завершённая мысль.""",
    }
    
    alternative_prompts = [
        "Напиши смешной пост о быте с азиатскими женщинами. С матом 1-2 раза. 500-650 символов.",
        "Напиши ироничный пост про азиатских женщин. С матом 1-2 раза. Без оскорблений. 500-650 символов.",
        "Напиши забавный пост про азиатских женщин. С юмором и матом. Без оскорблений. 500-650 символов.",
    ]
    ...
    for attempt in range(5):
        try:
            ...
            data = {
                ...
                "messages": [
                    {"role": "system", "content": "Ты стендап-комик Анатолий. Отвечай ТОЛЬКО готовым постом. НИКАКИХ РАССУЖДЕНИЙ. Только текст поста. Используй мат 1-2 раза (бля, сука, пиздец, хуйня). НЕ ОСКОРБЛЯЙ НАЦИОНАЛЬНОСТИ. С юмором и иронией."},
...
def get_fallback_caption() -> str:
    fallbacks = [
        "Вот вы сидите тут, паритесь, копите на квартиры, на тачки. А я смотрю на свою азиатку и понимаю: блядь, она может из пачки лапши и соевого соуса сделать ужин, который вы будете вспоминать неделю. И при этом она на меня не орет за беспорядок, а просто молча складывает мои носки в треугольнички.",
        ...
        "Знаете, что я понял? Азиатки - это лучшее, что случилось со мной. Они не такие, как все. Они особенные. И я готов за это бороться, сука.",
    ]
